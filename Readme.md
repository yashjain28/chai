...
This is a converted version of npm’s package: "chai". For IPM specifications, see
...
```javascript
var CHAI_IPM = chai_IPM
```

## npm
```javascript
var CHAI_IPM = require("chai")
```

To learn more about converting your own NodeJS Package to an IPM package, see [how to port npm to ipm](https://github.com/clearblade/ipm) or [create a servicedesk ticket](https://clearblade.atlassian.net/servicedesk/customer/portal/1)
